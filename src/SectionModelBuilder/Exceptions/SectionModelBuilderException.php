...
namespace pointybeard\Symphony\Extensions\SectionModelBuilder\Exceptions;

use pointybeard\Helpers\Exceptions\ReadableTrace;

class SectionModelBuilderException extends ReadableTrace\ReadableTraceException
{
}
